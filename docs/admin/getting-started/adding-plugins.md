...
Plugins are the most powerful way to extend the functionality of DivineMC beyond the configuration
...
DivineMC is compatible with both Spigot and Bukkit plugins. It's okay if a plugin does not explicitly
mention DivineMC compatibility. It'll still work.
